...
{
    public class ActualizeServerOnMatchMakerRequest : HttpRequestBase
    {
        ...
        public ActualizeServerOnMatchMakerRequest() : base(MatchmakerEndpoints.ActualizeServer)
        {
            
        }
        
        public ActualizeServerOnMatchMakerRequest(ServerIdentity serverIdentity, string name, string region, int peersCount, ushort httpPort = 0, ushort httpsPort = 0) : this()
        {
