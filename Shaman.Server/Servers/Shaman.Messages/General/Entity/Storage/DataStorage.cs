...
namespace Shaman.Messages.General.Entity.Storage
{
    ...
    public class DataStorage : EntityBase
    {
        ...
        public List<GlobalParameter> Parameters { get; set; }
        ...
        protected override void SerializeBody(ISerializer serializer)
        {
            ...
            serializer.WriteList(this.Parameters);
                
            serializer.WriteList(this.Currencies);
        }
        ...
        protected override void DeserializeBody(ISerializer serializer)
        {
            ...
            Parameters = serializer.ReadList<GlobalParameter>();
                
            Currencies = serializer.ReadList<Currency>();
        }
        ...
        public void ResetStorage()
        {
            ...
            this.Parameters = new List<GlobalParameter>();
