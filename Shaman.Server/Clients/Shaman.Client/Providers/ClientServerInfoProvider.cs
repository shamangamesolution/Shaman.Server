...
namespace Shaman.Client.Providers
{
    public class ClientServerInfoProvider : IClientServerInfoProvider
    {
        ...
        public async Task<List<Route>> GetRoutes(string routerUrl, string clientVersion)
        {
        ...
        private List<Route> BuildRoutes(string clientVersion, GetServerInfoListResponse response)
        {
            ...
            else
            {
                ...
                foreach (var region in regions)
                {
                    ...
                    if (pingHost != null && matchMaker != null && backEnd != null)
                    {
                        ...
                        result.Add(new Route(region, pingHost.Address, protocol, backEnd.Address, port,
