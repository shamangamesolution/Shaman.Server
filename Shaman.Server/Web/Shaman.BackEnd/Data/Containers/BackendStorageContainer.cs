...
namespace Shaman.BackEnd.Data.Containers
{
    public class BackendStorageContainer : StorageContainer
    {
        ...
        public BackendStorageContainer(IStorageContainerUpdater containerUpdater, IShamanLogger logger, ISerializerFactory serializerFactory, ITaskSchedulerFactory taskSchedulerFactory) 
